          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              <Image
                ...
                className="mr-3"
              />
              <span className="text-xl font-display font-bold text-icd-purple">
                ICD Foundation
              </span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="text-gray-700 hover:text-icd-purple transition-colors duration-200"
              >
                {item.name}
              </Link>
            ))}
            ...
            <div className="space-y-2">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-icd-purple transition-colors duration-200"
